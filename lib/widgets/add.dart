...
class AddPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(appBar: AppBar(title: Text("Add Page"), backgroundColor: Colors.red,),
      body: Column(
        children: [
          Text("Please fill in all info"),
          TextField(decoration: InputDecoration(hintText: "Enter task name"),controller:
          nameEditingController,),
          TextField(decoration: InputDecoration(hintText: "Enter task description"), controller: descEditingController,),
